...
{
    /// <inheritdoc />
    public partial class ReseedCardArtCatalogV2 : Migration
    {
        ...
        {
            // Second round of seed corrections since ReseedCardArtCatalog: the default-
            // art ordering fix, and — most importantly — tokens were being wrongly
            // collapsed across every base set (ALIZE/BISE/CORE/...) by the previous
            // reseed's dedup rule; tokens genuinely get new art per base set and only
            // their COREKS printing is a verbatim reprint of CORE. Same wipe-and-reload
            // approach so environments that already ran ReseedCardArtCatalog don't need
            // a database reset.
        ...
        {
            using var resource = typeof(ReseedCardArtCatalogV2).Assembly.GetManifestResourceStream(ResourceName)

...
{
    /// <inheritdoc />
    public partial class ReseedCardArtCatalogV4 : Migration
    {
        ...
        {
            // CardsData's EOLEOP ("Roots of Corruption - Organized Play") and EOLETOP
            // ("Roots of Corruption - Box Topper") set folders were added after the
            // catalog's last build and had been missed entirely -- 66 promo/alt-art
            // printings across 49 existing card families. Same wipe-and-reload approach
            // as the prior reseed migrations so environments that already migrated don't
        ...
        {
            using var resource = typeof(ReseedCardArtCatalogV4).Assembly.GetManifestResourceStream(ResourceName)

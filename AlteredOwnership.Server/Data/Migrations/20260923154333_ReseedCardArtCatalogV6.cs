...
{
    /// <inheritdoc />
    public partial class ReseedCardArtCatalogV6 : Migration
    {
        ...
        {
            // Adds the 4 EOLE box-topper Hero prints missing from CardsData's own
            // NonUniquePrints.csv despite each having its own LoreStories entry (confirmed
            // real, physically owned prints, not typos): ALT_EOLE_P_LY_105_C,
            // ALT_EOLE_P_MU_65_C, ALT_EOLE_P_OR_65_C, ALT_EOLE_P_YZ_105_C. Their sibling
            // AX_65/BR_105 box-toppers were already seeded; these 4 factions were simply
            // never added upstream.
        ...
        {
            using var resource = typeof(ReseedCardArtCatalogV6).Assembly.GetManifestResourceStream(ResourceName)

...
{
    /// <inheritdoc />
    public partial class ReseedCardArtCatalogV5 : Migration
    {
        ...
        {
            // ALT_EOLETOP_P_AX_49_R1 was a typo: that printing doesn't exist. The real
            // EOLETOP box-topper print of Sap Sniffer is the common ALT_EOLETOP_P_AX_49_C.
        ...
        {
            using var resource = typeof(ReseedCardArtCatalogV5).Assembly.GetManifestResourceStream(ResourceName)
